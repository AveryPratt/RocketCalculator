...
namespace KSP_Library
{
    ...
    namespace Systems
    {
        ...
        {
            internal abstract Body[] SystemBodies();
            public Body GetSystemBody(string bodyName)
            {
                Body[] system = SystemBodies();
                foreach (Body body in system)
                {
                    if(body.Name.ToUpper() == bodyName)
                    {
                        return body;
                    }
                }
        ...
        {
            internal override Body[] SystemBodies()
            {
        ...
        class RealSolarSystem : SolarSystem
        {
            internal override Body[] SystemBodies()
            {
                Body[] bodies = new Body[17];
