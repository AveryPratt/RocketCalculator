...
<body>
    <form id="form1" runat="server">
        ...
        <asp:DropDownList ID="ParentBodyDropDownList" runat="server" Enabled="False" Height="16px" AutoPostBack="True">
            ...
            <asp:CheckBox ID="MinTWRCheckBox" runat="server" Text="min" Checked="True" AutoPostBack="True" Enabled="False" OnCheckedChanged="MinTWRCheckBox_CheckedChanged" />
            <asp:CheckBox ID="MaxTWRCheckBox" runat="server" Text="max" Checked="True" AutoPostBack="True" Enabled="False" OnCheckedChanged="MaxTWRCheckBox_CheckedChanged" />
        <p>
        ...
        <asp:Table ID="RocketTable" runat="server" GridLines="Both">
            <asp:TableRow runat="server">
                ...
                <asp:TableCell Width="100" runat="server" Text="DeltaV (m/s):" />
            </asp:TableRow>
        ...
        <p>
            <asp:Button ID="CalculateButton" runat="server" Text="Calculate" Visible="False" OnClick="CalculateButton_Clicked" />
        </p>
    </form>
</body>
</html>
