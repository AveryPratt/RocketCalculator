            ...
            <div id="wrapper">
                <header>
                    ...
                    <div id="UserNameDiv" class="HeaderDiv" runat="server">
                        <div class="AccountLink" id="UserName" runat="server"></div>
                        <asp:LinkButton CssClass="AccountLink" ID="LogoutButton" runat="server" OnClick="LogoutButton_Click">Logout</asp:LinkButton>
                    </div>
                ...
                <div id="content">
                    ...
                    <div id="DefaultRocketsDiv" class="ContentDiv" runat="server">
                        <p>Rocket Templates</p>
                        <asp:GridView ID="DefaultRocketsGridView" CssClass="DefaultRocketsDiv" runat="server" OnRowCommand="UserRocketsGridView_RowCommand" AutoGenerateColumns="false">
                            <Columns>
                                <asp:CommandField ShowSelectButton="true" />
                                <asp:BoundField DataField="RocketID" HeaderText="RocketID" ItemStyle-CssClass="hiddenColumn"  HeaderStyle-CssClass="hiddenColumn"/>
                                <asp:BoundField DataField="RocketName" HeaderText="Rocket Name"/>
                                <asp:BoundField DataField="Payload" HeaderText="Payload Mass"/>
                                <asp:BoundField DataField="ParentBody" HeaderText="Parent Body"/>
                                <asp:BoundField DataField="StageNumber" HeaderText="Number of Stages"/>
                            </Columns>
                        </asp:GridView>
                    </div>
                    <div id="UserRocketsDiv" class="ContentDiv" runat="server" visible="false">
                        <p id="UserRocketsLabel" runat="server"></p>
                        <asp:GridView ID="UserRocketsGridView" CssClass="UserRocketsDiv" runat="server" OnRowCommand="UserRocketsGridView_RowCommand" OnRowDeleting="UserRocketsGridView_RowDeleting" AutoGenerateColumns="false">
                            <Columns>
                                <asp:CommandField ShowSelectButton="true" />
                                <asp:BoundField DataField="RocketID" HeaderText="RocketID" ItemStyle-CssClass="hiddenColumn"  HeaderStyle-CssClass="hiddenColumn"/>
                                <asp:BoundField DataField="RocketName" HeaderText="Rocket Name"/>
